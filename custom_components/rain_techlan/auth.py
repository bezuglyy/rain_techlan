"""Techlan Полив authentication using curl_cffi to bypass AWS WAF."""
...
def fetch_token(username: str, password: str) -> str:
    """
    Authenticate with Techlan Полив and return a JWT access token.
...
class RainBirdAuth:
    ...
    def __init__(
        ...
        self._cache_path = hass.config.path(
            ".storage", f"rain_techlan_token_{account_hash}.json"
        )
